...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Sunrise.xiao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个爱好广泛的干饭人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Sunrise.xiao.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Neverland, Notion, 永无乡, 博客', // 网站关键词 英文逗号隔开
